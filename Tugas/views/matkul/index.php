            ...
            <div class="container-fluid border p-5 mt-4 bg-light rounded">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <?php 
                        $no = 1; // inisiasi nomor
                        // menampilkan data matkul dari database
                        foreach($matkul as $x) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="edit_matkul?id=<?php echo $x['kode_matkul']; ?>">Edit</a>
                                    <a class="btn btn-danger" href="delete_matkul?id=<?php echo $x['kode_matkul']; ?>" onclick="return confirm('Apakah yakin akan menghapus')">Hapus</a>
                                </td>
                            </tr>
                        <?php 
                        }
